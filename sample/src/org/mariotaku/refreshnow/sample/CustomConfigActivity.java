...
public class CustomConfigActivity extends Activity implements OnRefreshListener {
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		final RefreshNowConfig.Builder cb = new RefreshNowConfig.Builder(this);
		cb.maxOverScrollDistance(128);
		cb.minPullDivisor(1);
		cb.extraPullDivisor(1);
		mListView.setConfig(cb.build());
	}
